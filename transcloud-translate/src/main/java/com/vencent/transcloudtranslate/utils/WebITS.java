...
public class WebITS {
     ...
     * 组装http请求头
     */
    public static Map<String, String> buildHttpHeader(String body,String WebITS_URL,String API_KEY, String API_SECRET) throws Exception {
     ...
     * 组装http请求体
     */
    public static String buildHttpBody(String APPID,String FROM,String TO,String TEXT) throws Exception {
