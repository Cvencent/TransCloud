...
public class WebIATWS extends WebSocketListener {
    private String hostUrl = "https://iat-api.xfyun.cn/v2/iat"; //中英文，http url 不支持解析 ws/wss schema
    ...
    public WebIATWS(String apiKey,String apiSecret,String appid){
        this.apiKey = apiKey;
    ...
    public String getStrResult() throws InterruptedException {
        return StrResult;
    }
    public ResponseData getResponseData() throws InterruptedException {
        //延迟获取结果
        while (resp.getData().getStatus() != 2){
    ...
    public void onOpen(WebSocket webSocket, Response response) {
        ...
        new Thread(()->{
            ...
            int intervel = 40;
            int status = 0;  // 音频的状态
            try (ByteArrayInputStream fs = new ByteArrayInputStream(file)) {
